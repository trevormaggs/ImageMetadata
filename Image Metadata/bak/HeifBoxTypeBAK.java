...
public enum HeifBoxTypeBAK
{
    ...
    BOX_ITEM_PROPERTIES("iprp", BoxCategory.CONTAINER),    
    BOX_ITEM_PROPERTYCONTAINER("ipco", BoxCategory.CONTAINER),    
     ...
     */
    private HeifBoxTypeBAK(String name, BoxCategory category)
    {
        this.boxname = name;
     ...
     */
    public boolean equalsType(HeifBoxTypeBAK type)
    {
        return this == type;
    }
     ...
     */
    public static HeifBoxTypeBAK getBoxType(String name)
    {
        for (HeifBoxTypeBAK type : values())
        {
     ...
     * @return the corresponding {@code HeifBoxType}, or {@link #UNKNOWN} if not recognised
     */
    public static HeifBoxTypeBAK getBoxType(byte[] raw)
    {
        for (HeifBoxTypeBAK type : values())
        {
