 ...
 */
public class ImageFileInputStream3 implements AutoCloseable
{
     ...
     */
    public ImageFileInputStream3(InputStream fis)
    {
     ...
     */
    public ImageFileInputStream3(InputStream fis, ByteOrder order)
    {
        if (fis == null)
        {
