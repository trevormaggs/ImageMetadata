...
public class JpgParserOrig extends AbstractImageParser
{
     ...
     */
    private byte[] readRawSegmentData(ImageFileInputStream stream, JpegSegmentConstantsOrig segment) throws IOException
    {
        final JpegSegmentConstantsOrig EOS = JpegSegmentConstantsOrig.END_OF_IMAGE;
    ...
    public Metadata<? extends BaseMetadata> readMetadata() throws ImageReadErrorException
    {
        ...
        {
            app1SegmentBytes = readRawSegmentData(jpgStream, JpegSegmentConstantsOrig.APP1_SEGMENT);
